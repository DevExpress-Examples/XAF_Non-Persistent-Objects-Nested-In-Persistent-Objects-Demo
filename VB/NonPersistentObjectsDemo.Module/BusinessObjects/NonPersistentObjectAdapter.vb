...
'INSTANT VB NOTE: The field objectSpace was renamed since Visual Basic does not allow fields to have the same name as other class members:
		...
		Public Sub New(ByVal npos As NonPersistentObjectSpace)
			...
			AddHandler objectSpace_Conflict.ObjectGetting, AddressOf ObjectSpace_ObjectGetting
			AddHandler objectSpace_Conflict.ObjectByKeyGetting, AddressOf ObjectSpace_ObjectByKeyGetting
			AddHandler objectSpace_Conflict.Reloaded, AddressOf ObjectSpace_Reloaded
			AddHandler objectSpace_Conflict.ObjectReloading, AddressOf ObjectSpace_ObjectReloading
			AddHandler objectSpace_Conflict.CustomCommitChanges, AddressOf ObjectSpace_CustomCommitChanges
		...
		Protected Overridable Function GetKeyValue(ByVal obj As TObject) As TKey
			Return CType(objectSpace_Conflict.GetKeyValue(obj), TKey)
		End Function
				...
				If link IsNot Nothing Then
					...
					Else
						If link.ObjectSpace.IsNewObject(obj) Then
							If link.ObjectSpace = objectSpace_Conflict Then
		...
		Private Sub ObjectSpace_CustomCommitChanges(ByVal sender As Object, ByVal e As HandledEventArgs)
			...
			For Each obj In objectSpace_Conflict.ModifiedObjects
