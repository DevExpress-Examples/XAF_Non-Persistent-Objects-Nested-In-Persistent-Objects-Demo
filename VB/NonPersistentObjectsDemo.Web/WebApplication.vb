...
#End If
		End Sub
		Public Overrides Function GetObjectSpaceToShowDetailViewFrom(ByVal sourceFrame As Frame, ByVal objectType As Type, ByVal targetWindow As TargetWindow) As IObjectSpace
			If TypeOf sourceFrame.View Is ListView AndAlso sourceFrame.View.ObjectTypeInfo.Type Is GetType(NonPersistentObjectsDemo.Module.BusinessObjects.Agent) AndAlso objectType Is GetType(NonPersistentObjectsDemo.Module.BusinessObjects.Agent) Then
				Return sourceFrame.View.ObjectSpace
			End If
			Return MyBase.GetObjectSpaceToShowDetailViewFrom(sourceFrame, objectType, targetWindow)
		End Function
