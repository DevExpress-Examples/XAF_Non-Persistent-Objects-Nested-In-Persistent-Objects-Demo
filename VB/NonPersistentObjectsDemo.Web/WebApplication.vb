...
#End If
		...
		Public Overrides Function GetObjectSpaceToShowDetailViewFrom(ByVal sourceFrame As Frame, ByVal objectType As Type, ByVal targetWindow As TargetWindow) As IObjectSpace
			If TypeOf sourceFrame.View Is ListView AndAlso sourceFrame.View.ObjectTypeInfo.Type Is GetType(System.Reflection.Module.BusinessObjects.Agent) AndAlso objectType Is GetType(System.Reflection.Module.BusinessObjects.Agent) Then
